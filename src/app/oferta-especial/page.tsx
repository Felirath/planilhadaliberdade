    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-grow py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <Card className="max-w-2xl mx-auto bg-gradient-orange text-accent-foreground p-6 md:p-8 rounded-xl shadow-xl mb-12 text-center animate-fade-in-up">
          ...
          <section className="max-w-3xl mx-auto mb-12 text-center animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <h2 className="text-3xl md:text-4xl font-bold text-destructive mb-4">
              <XCircle className="inline-block h-10 w-10 mr-2" /> PARE! NÃO COMETA ESSE ERRO
            </h2>
            <p className="text-xl font-semibold text-muted-foreground mb-2">
              Você estava prestes a escolher o plano básico por R$ 9,90...
            </p>
            <p className="text-lg text-foreground bg-destructive/10 p-3 rounded-md">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
            <div className="bg-red-100 border-2 border-red-500 p-6 rounded-lg shadow-lg animate-fade-in-up" style={{animationDelay: '0.4s'}}>
            ...
            <div className="bg-green-100 border-2 border-green-600 p-6 rounded-lg shadow-lg animate-fade-in-up" style={{animationDelay: '0.5s'}}>
          ...
          <Card className="max-w-md mx-auto bg-gradient-green text-primary-foreground p-6 md:p-8 rounded-xl shadow-2xl animate-fade-in-up" style={{animationDelay: '0.6s'}}>
            ...
            <CardContent className="p-0 text-center">
              ...
              <p className="text-5xl font-bold my-2">AGORA: R$ 15,90</p>
              <Button 
                size="lg" 
          ...
          <div className="text-center mt-8 animate-fade-in-up" style={{animationDelay: '0.7s'}}>
            <Link href="https://pay.kirvano.com/d97db0df-9bb9-4183-a0d6-23a538c79338" className="text-sm text-muted-foreground hover:text-primary underline">
