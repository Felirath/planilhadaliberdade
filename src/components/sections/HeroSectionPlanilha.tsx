  ...
  return (
    <section className="py-12 md:py-20 bg-gradient-green-blue text-primary-foreground">
      <div className="container mx-auto px-6 md:px-10 text-center">
        ...
        <div className="max-w-2xl mx-auto mb-8 rounded-lg shadow-2xl overflow-hidden animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          <VSLPlayer 
        ...
        <Card className="max-w-md mx-auto bg-card text-card-foreground shadow-xl p-6 md:p-8 animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
          <CardContent className="p-0">
            ...
            <Link href="#oferta" passHref>
              <Button 
                size="lg" 
                className="w-full bg-gradient-orange hover:opacity-90 hover:scale-105 transform transition-all duration-300 text-accent-foreground font-semibold text-lg shadow-lg mb-3"
              >
                Obter Agora
              </Button>
            </Link>
