...
const PixIconSmall = () => (
  <svg width="20" height="20" viewBox="0 0 256 256" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-destructive-foreground/70">
...
const BlueCardIconSmall = () => (
  <svg width="24" height="24" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto text-destructive-foreground/70">
