...
const PixIconSmall = () => (
  <svg width="20" height="20" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-destructive-foreground/70">
  ...
  return (
    <section className="py-16 md:py-24 bg-destructive text-destructive-foreground">
      <div className="container mx-auto px-6 md:px-10 text-center">
        <div className="max-w-2xl mx-auto bg-card/10 backdrop-blur-sm p-8 rounded-xl shadow-2xl animate-fade-in-up border border-destructive-foreground/20">
          ...
          <div className="my-6 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
            ...
            <Badge variant="default" className="text-sm py-1.5 px-4 bg-yellow-400 text-yellow-900 font-semibold shadow-md">ECONOMIA DE R$ 50,00</Badge>
          </div>

          <Button 
            size="lg" 
            className="w-full text-xl font-bold bg-gradient-yellow hover:opacity-95 hover:scale-105 transform transition-transform duration-300 text-black shadow-lg mb-6 animate-fade-in-up"
          ...
          <div className="flex justify-center items-center space-x-3 mb-4 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              <CreditCard className="h-6 w-6 text-destructive-foreground/70" />
              <PixIconSmall />
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-banknote h-6 w-6 text-destructive-foreground/70"><rect width="20" height="12" x="2" y="6" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>
          </div>
